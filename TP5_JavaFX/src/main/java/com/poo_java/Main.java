...
public class Main {
    ...
    private static void addProfesseur() {
        ...
        Professeur professeur = new Professeur(0, nom, prenom, cin, adresse, telephone, email, Date.valueOf(date), deptId);
    ...
    private static void updateProfesseur() {
        ...
        Professeur professeur = new Professeur(id, nom, prenom, cin, adresse, telephone, email, Date.valueOf(date), deptId);
        Boolean success = metier.updateProfesseur(professeur);
        if (success){
    ...
    private static void deleteProfesseur() {
        ...
        int id = scanner.nextInt();
        Boolean success = metier.removeProfesseur(id);
        if (success){
